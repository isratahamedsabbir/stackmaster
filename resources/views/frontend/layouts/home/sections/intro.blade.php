...
<section id="home" class="home d-flex align-items-center">
    <div class="container">
        ...
        <div class="intro">
            <!-- avatar image -->
            <img src="{{ asset(!empty($cms_intro->image) && file_exists(public_path($cms_intro->image)) ? $cms_intro->image : 'default/logo.svg') }}" alt="Bolby" class="mb-4" style="width: 150px; height: 250px"/>
