...
class ChatController extends Controller
{
    ...
    public function list(): JsonResponse
    {
        ...
        $users = User::select('id', 'name', 'avatar', 'last_activity_at')
    ...
    public function search(Request $request): JsonResponse
    {
        ...
        $users = User::select('id', 'name', 'email', 'avatar', 'last_activity_at')->where('id', '!=', $user_id)->where(function ($query) use ($search) {
    ...
    public function seenAll($receiver_id): JsonResponse
    {
        ...
        $chat = Chat::where('receiver_id', $receiver_id)->where('sender_id', $sender_id)->update(['status' => 'read']);
    ...
    public function seenSingle($chat_id): JsonResponse
    {
        ...
        $chat = Chat::where('id', $chat_id)->where('sender_id', $sender_id)->update(['status' => 'read']);
